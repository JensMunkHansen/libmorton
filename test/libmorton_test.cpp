// Libmorton Tests
// This is a program designed to test and benchmark the functionality offered by the libmorton
// library
//
// Jeroen Baert 2015
...
void registerFunctions()
{
  ...
  f3D_64_encode.push_back(encode_3D_64_wrapper(
    "LUT Pre-shifted Early Termination", &m3D_e_sLUT_ET<uint_fast64_t, uint_fast32_t>));
  f3D_64_encode.push_back(
    encode_3D_64_wrapper("LUT Pre-shifted", &m3D_e_sLUT<uint_fast64_t, uint_fast32_t>));
  f3D_64_encode.push_back(
    encode_3D_64_wrapper("LUT Early Termination", &m3D_e_LUT_ET<uint_fast64_t, uint_fast32_t>));
  f3D_64_encode.push_back(encode_3D_64_wrapper("LUT", &m3D_e_LUT<uint_fast64_t, uint_fast32_t>));
  f3D_64_encode.push_back(
    encode_3D_64_wrapper("Magicbits", &m3D_e_magicbits<uint_fast64_t, uint_fast32_t>));
  f3D_64_encode.push_back(
    encode_3D_64_wrapper("For ET", &m3D_e_for_ET<uint_fast64_t, uint_fast32_t>));
  ...
  f3D_32_encode.push_back(encode_3D_32_wrapper(
    "LUT Pre-shifted Early Termination", &m3D_e_sLUT_ET<uint_fast32_t, uint_fast16_t>));
  f3D_32_encode.push_back(
    encode_3D_32_wrapper("LUT Pre-shifted", &m3D_e_sLUT<uint_fast32_t, uint_fast16_t>));
  f3D_32_encode.push_back(
    encode_3D_32_wrapper("LUT Early Termination", &m3D_e_LUT_ET<uint_fast32_t, uint_fast16_t>));
  f3D_32_encode.push_back(encode_3D_32_wrapper("LUT", &m3D_e_LUT<uint_fast32_t, uint_fast16_t>));
  f3D_32_encode.push_back(
    encode_3D_32_wrapper("Magicbits", &m3D_e_magicbits<uint_fast32_t, uint_fast16_t>));
  f3D_32_encode.push_back(
    encode_3D_32_wrapper("For ET", &m3D_e_for_ET<uint_fast32_t, uint_fast16_t>));
  ...
  f3D_64_decode.push_back(decode_3D_64_wrapper(
    "LUT Pre-shifted Early Termination", &m3D_d_sLUT_ET<uint_fast64_t, uint_fast32_t>));
  f3D_64_decode.push_back(
    decode_3D_64_wrapper("LUT Pre-shifted", &m3D_d_sLUT<uint_fast64_t, uint_fast32_t>));
  f3D_64_decode.push_back(
    decode_3D_64_wrapper("LUT Early Termination", &m3D_d_LUT_ET<uint_fast64_t, uint_fast32_t>));
  f3D_64_decode.push_back(decode_3D_64_wrapper("LUT", &m3D_d_LUT<uint_fast64_t, uint_fast32_t>));
  f3D_64_decode.push_back(
    decode_3D_64_wrapper("Magicbits", &m3D_d_magicbits<uint_fast64_t, uint_fast32_t>));
  f3D_64_decode.push_back(
    decode_3D_64_wrapper("For ET", &m3D_d_for_ET<uint_fast64_t, uint_fast32_t>));
  ...
  f3D_32_decode.push_back(decode_3D_32_wrapper(
    "LUT Pre-shifted Early Termination", &m3D_d_sLUT_ET<uint_fast32_t, uint_fast16_t>));
  f3D_32_decode.push_back(
    decode_3D_32_wrapper("LUT Pre-shifted", &m3D_d_sLUT<uint_fast32_t, uint_fast16_t>));
  f3D_32_decode.push_back(
    decode_3D_32_wrapper("LUT Early Termination", &m3D_d_LUT_ET<uint_fast32_t, uint_fast16_t>));
  f3D_32_decode.push_back(decode_3D_32_wrapper("LUT", &m3D_d_LUT<uint_fast32_t, uint_fast16_t>));
  f3D_32_decode.push_back(
    decode_3D_32_wrapper("Magicbits", &m3D_d_magicbits<uint_fast32_t, uint_fast16_t>));
  f3D_32_decode.push_back(
    decode_3D_32_wrapper("For ET", &m3D_d_for_ET<uint_fast32_t, uint_fast16_t>));
  ...
  f3D_64_encode.push_back(
    encode_3D_64_wrapper("BMI2 instruction set", &m3D_e_BMI<uint_fast64_t, uint_fast32_t>));
  f3D_32_encode.push_back(
    encode_3D_32_wrapper("BMI2 instruction set", &m3D_e_BMI<uint_fast32_t, uint_fast16_t>));
  f3D_64_decode.push_back(
    decode_3D_64_wrapper("BMI2 Instruction set", &m3D_d_BMI<uint_fast64_t, uint_fast32_t>));
  f3D_32_decode.push_back(
    decode_3D_32_wrapper("BMI2 Instruction set", &m3D_d_BMI<uint_fast32_t, uint_fast16_t>));
#endif

  // Register 3D AVX512 intrinsics if available
#if defined(__AVX512BITALG__)
  f3D_64_encode.push_back(
    encode_3D_64_wrapper("AVX512 instruction set", &m3D_e_BITALG<uint_fast64_t, uint_fast32_t>));
  f3D_32_encode.push_back(
    encode_3D_32_wrapper("AVX512 instruction set", &m3D_e_BITALG<uint_fast32_t, uint_fast16_t>));
  f3D_64_decode.push_back(
    decode_3D_64_wrapper("AVX512 Instruction set", &m3D_d_BITALG<uint_fast64_t, uint_fast32_t>));
  f3D_32_decode.push_back(
    decode_3D_32_wrapper("AVX512 Instruction set", &m3D_d_BITALG<uint_fast32_t, uint_fast16_t>));
#endif

  // Register 2D 64-bit encode functions
  f2D_64_encode.push_back(encode_2D_64_wrapper(
    "LUT Pre-shifted Early Termination", &m2D_e_sLUT_ET<uint_fast64_t, uint_fast32_t>));
  f2D_64_encode.push_back(
    encode_2D_64_wrapper("LUT Pre-shifted", &m2D_e_sLUT<uint_fast64_t, uint_fast32_t>));
  f2D_64_encode.push_back(
    encode_2D_64_wrapper("LUT Early Termination", &m2D_e_LUT_ET<uint_fast64_t, uint_fast32_t>));
  f2D_64_encode.push_back(encode_2D_64_wrapper("LUT", &m2D_e_LUT<uint_fast64_t, uint_fast32_t>));
  f2D_64_encode.push_back(
    encode_2D_64_wrapper("Magicbits", &m2D_e_magicbits<uint_fast64_t, uint_fast32_t>));
  f2D_64_encode.push_back(
    encode_2D_64_wrapper("For ET", &m2D_e_for_ET<uint_fast64_t, uint_fast32_t>));
  ...
  f2D_32_encode.push_back(
    encode_2D_32_wrapper("LUT Pre-shifted", &m2D_e_sLUT<uint_fast32_t, uint_fast16_t>));
  f2D_32_encode.push_back(
  ...
  f2D_64_decode.push_back(decode_2D_64_wrapper(
    "LUT Pre-shifted Early Termination", &m2D_d_sLUT_ET<uint_fast64_t, uint_fast32_t>));
  f2D_64_decode.push_back(
    decode_2D_64_wrapper("LUT Pre-shifted", &m2D_d_sLUT<uint_fast64_t, uint_fast32_t>));
  f2D_64_decode.push_back(
    decode_2D_64_wrapper("LUT Early Termination", &m2D_d_LUT_ET<uint_fast64_t, uint_fast32_t>));
  f2D_64_decode.push_back(decode_2D_64_wrapper("LUT", &m2D_d_LUT<uint_fast64_t, uint_fast32_t>));
  f2D_64_decode.push_back(
    decode_2D_64_wrapper("Magicbits", &m2D_d_magicbits<uint_fast64_t, uint_fast32_t>));
  f2D_64_decode.push_back(
    decode_2D_64_wrapper("For ET", &m2D_d_for_ET<uint_fast64_t, uint_fast32_t>));
  ...
  f2D_32_decode.push_back(
    decode_2D_32_wrapper("LUT Pre-shifted", &m2D_d_sLUT<uint_fast32_t, uint_fast16_t>));
  f2D_32_decode.push_back(
...
int main(int argc, char* argv[])
{
  ...
  cout << "++ Stopped because we were instructed only to run tests until we hit " << MAXRUNSIZE
       << "^3 codes" << endl;
}
